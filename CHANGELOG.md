...
### Changed
- Refactored `UsSensor::read_distance` logging: eliminated string formatting inside the ping measurement loop and moved ping formatting on-demand inside `ESP_LOGD`.
...
[1.1.1]: https://github.com/aluiziotomazelli/ultrasonic_sensor/releases/tag/v1.1.1
